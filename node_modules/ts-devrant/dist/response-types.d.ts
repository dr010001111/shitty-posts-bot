import { Notifications, Token, Tags, RantInFeed, SessionHash, News, Profile, DevRantSupporter } from "./types";
...
export declare type RegisterResponse = AuthResponse | FailureRegisterResponse;
